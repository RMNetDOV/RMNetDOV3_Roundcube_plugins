...
class rmnetdov3_spam extends rcube_plugin
{
    ...
    function init()
    {
        ...
        $this->register_action('plugin.rmnetdov3_spam', [$this, 'init_html']);
        $this->register_action('plugin.rmnetdov3_spam.save', [$this, 'save']);

        if (strpos($this->rcmail->action, 'plugin.rmnetdov3_spam') === 0) {
    ...
    function init_html()
    {
        ...
        $this->rcmail->output->send('rmnetdov3_spam.spam');
    }
    ...
    function gen_form($attrib)
    {
        ...
        $out = $this->rcmail->output->request_form([
            ...
            'method'  => 'post',
            'task'    => 'settings',
            'action'  => 'plugin.rmnetdov3_spam.save',
            'noclose' => true
        ] + $attrib);
