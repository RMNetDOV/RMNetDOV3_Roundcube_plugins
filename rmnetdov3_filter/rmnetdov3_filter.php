...
class rmnetdov3_filter extends rcube_plugin
{
    ...
    function init()
    {
        ...
        $this->register_action('plugin.rmnetdov3_filter', [$this, 'init_html']);
        $this->register_action('plugin.rmnetdov3_filter.show', [$this, 'init_html']);
        $this->register_action('plugin.rmnetdov3_filter.save', [$this, 'save']);
        $this->register_action('plugin.rmnetdov3_filter.del', [$this, 'del']);

        if (strpos($this->rcmail->action, 'plugin.rmnetdov3_filter') === 0) {
    ...
    function init_html()
    {
        ...
        $this->rcmail->output->send('rmnetdov3_filter.filter');
    }
    ...
    {
        $this->rcmail->output->add_label('rmnetdov3_filter.filterdelconfirm', 'rmnetdov3_filter.textempty');
        ...
        $out = $this->rcmail->output->request_form([
                ...
                'method'  => 'post',
                'task'    => 'settings',
                'action'  => 'plugin.rmnetdov3_filter.save',
                'noclose' => true
            ] + $attrib);
