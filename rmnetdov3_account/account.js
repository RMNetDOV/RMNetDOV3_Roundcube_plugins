window.rcmail && rcmail.addEventListener('init', function (evt) {
    rcmail.register_command('plugin.rmnetdov3_account', function () {
        rcmail.goto_url('plugin.rmnetdov3_account')
    }, true);

    if (rcmail.env.action.startsWith('plugin.rmnetdov3_account')) {
...
rcube_webmail.prototype.plugin_select = function (list) {
    ...
    if (id) {
        ...
        rcmail.location_href(this.env.comm_path + '&_action=plugin.rmnetdov3_' + id + add_url, target, true);
    }
