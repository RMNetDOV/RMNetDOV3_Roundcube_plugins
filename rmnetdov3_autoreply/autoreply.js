window.rcmail && rcmail.addEventListener('init', function (evt) {
    rcmail.register_command('plugin.rmnetdov3_autoreply.save', function () {
        ...
        if (input_text.value == '' && input_enabled.checked) {
            parent.rcmail.display_message(rcmail.gettext('rmnetdov3_autoreply.textempty'), 'error');
            input_text.focus();
        }
    ...
    if (rcmail.env.action.startsWith('plugin.rmnetdov3_autoreply')) {
