...
class rmnetdov3_autoreply extends rcube_plugin
{
    ...
    function init()
    {
        ...
        $this->register_action('plugin.rmnetdov3_autoreply', [$this, 'init_html']);
        $this->register_action('plugin.rmnetdov3_autoreply.save', [$this, 'save']);

        if (strpos($this->rcmail->action, 'plugin.rmnetdov3_autoreply') === 0) {
    ...
    function init_html()
    {
        ...
        $this->rcmail->output->send('rmnetdov3_autoreply.autoreply');
    }
    ...
    {
        $this->rcmail->output->add_label('rmnetdov3_autoreply.textempty');
        ...
        $out = $this->rcmail->output->request_form([
                ...
                'method'  => 'post',
                'task'    => 'settings',
                'action'  => 'plugin.rmnetdov3_autoreply.save',
                'noclose' => true
            ] + $attrib);
