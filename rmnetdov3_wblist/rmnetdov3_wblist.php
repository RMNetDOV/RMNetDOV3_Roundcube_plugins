...
class rmnetdov3_wblist extends rcube_plugin
{
    ...
    function init()
    {
        ...
        $this->register_action('plugin.rmnetdov3_wblist', [$this, 'init_html']);
        $this->register_action('plugin.rmnetdov3_wblist.save', [$this, 'save']);
        $this->register_action('plugin.rmnetdov3_wblist.del', [$this, 'del']);

        if (strpos($this->rcmail->action, 'plugin.rmnetdov3_wblist') === 0) {
    ...
    function init_html()
    {
        ...
        $this->rcmail->output->send('rmnetdov3_wblist.wblist');
    }
    ...
    {
        $this->rcmail->output->add_label('rmnetdov3_wblist.wblistdelconfirm', 'rmnetdov3_wblist.textempty',
            'rmnetdov3_wblist.invalidaddress');
        ...
        $out = $this->rcmail->output->request_form([
                ...
                'method'  => 'post',
                'task'    => 'settings',
                'action'  => 'plugin.rmnetdov3_wblist.save',
                'noclose' => true
            ] + $attrib);
    ...
    private function _rule_row($rule_table, $name, $wb, $active, $id, $attrib)
    {
        ...
        $list_button = $this->api->output->button([
            ...
            'innerclass' => 'inner',
            'content' => '',
            'title' => 'rmnetdov3_wblist.wblist' . $list
        ]);
